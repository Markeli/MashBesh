...
namespace MashBesh
{
    class MultiplayerGameMap
    {
        ...
        public void ReIndexCells(int newCurrentPlayersNumber)
        {
            for (int i = currentPlayersNumber; i < maxPlayersNumber; ++i)
            {
                DirectReIndexCells();
            }
            currentPlayersNumber = newCurrentPlayersNumber;
        ...
        private void DirectReIndexCells()
        {
