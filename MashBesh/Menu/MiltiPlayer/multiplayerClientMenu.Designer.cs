namespace MashBesh
{
    partial class clientMultiPlayerMenu
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(clientMultiPlayerMenu));
            ...
            this.firstConnectionWaitingTimer = new System.Windows.Forms.Timer(this.components);
            this.SuspendLayout();
            // 
            // button6
            // 
            ...
            this.cancelMultiplayerButton.Location = new System.Drawing.Point(158, 467);
            ...
            this.timeCountDown.Tag = "5";
            this.timeCountDown.Tick += new System.EventHandler(this.TimeCountDownTick);
            // 
            // firstConnectionWaitingTimer
            // 
            this.firstConnectionWaitingTimer.Enabled = true;
            this.firstConnectionWaitingTimer.Tick += new System.EventHandler(this.FirstConnectionWaitingTimerTick);
            // 
            // clientMultiPlayerMenu
            // 
            ...
            this.Name = "clientMultiPlayerMenu";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Клиент";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ClientMultiPlayerMenuFormClosing);
            this.Load += new System.EventHandler(this.ClientMultiPlayerMenuLoad);
        ...
        private System.Windows.Forms.Timer firstConnectionWaitingTimer;
    }
}